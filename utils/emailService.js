  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
        ...
        👉 <a href="https://www.instagram.com/cumunofficial" style="color: #2980b9;">@cumunofficial</a></p>

        <p>If you have any queries, feel free to contact us at <a href="mailto:iste.cu@chandigarh.edu">iste.cu@chandigarh.edu</a></p>
